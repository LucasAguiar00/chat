...
<body style="background-color: #35363f; overflow-x: hidden;" onmousemove="mudar_titulo()" id="corpo_tela_principal">
    ...
    <header class="conteiner-fluid _header">
        <nav class="navbar text-white m-auto p-2" style="max-width: 1920px; background: rgb(53, 54, 63);">
            ...
            <span id="botoes_mais_usuais">
                ...
                <button type="button" id="" class="btn btn-danger lupa" data-toggle="modal"
                    data-target="#padrao_noc">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Padrão de repasse de casos">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button type="button" id="modelo_financeiro" class="btn btn-success lupa" data-toggle="modal"
                    data-target="#modal_modelo_financeiro">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Modelo de repasse financeiro">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button type="button" id="link_atalho_chat" class="btn btn-primary lupa" data-toggle="modal"
                    data-target="#">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Atalhos para o chat">
                ...
                <button type="button" id="" class="btn btn-info lupa" data-toggle="modal"
                    data-target="#modal_modelo_multa">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Cálculo de multa">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button type="button" id="modelo_pontoADC" class="btn btn-warning lupa" data-toggle="modal"
                    data-target="#modal_pontoADC">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Ponto Adicional">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button type="button" id="tema" class="btn btn-outline-dark lupa" onclick="mudar_tema()">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Mudar tema">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white"
                ...
                <button type="button" id="" class="btn btn-secondary lupa" onclick="transposto()">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Mudar layout">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button type="button" id="" class="btn btn-secondary lupa" data-toggle="modal"
                    data-target="#modal_mudar_tema">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Mudar plano de fundo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <button type="button" id="Perguntepulpo" class="btn btn-secondary lupa" data-toggle="modal"
                    data-target="#ModalPerguntepulpo" style="background-color: #563d7c; border-color: #563d7c;">                    
                    <span data-toggle="tooltip" data-placement="bottom" title="Pergunte ao pulpo (necessário já ter logado 1 vez no dia).">
                        🐙
                    </span>
                </button>
    ...
    <!-- Modal Pergunte ao pulpo -->
    <div class="modal fade" id="ModalPerguntepulpo" tabindex="3" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Qual sua dúvida?</h5>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 620px">
            <div class="modal-content">
                ...
                <div class="modal-body" id="campo_padrao_verificao">
                    ...
                    <br> <br> 
                    <strong>Obs.:Quando o cliente tem um plano de internet com valor desatualizado, ao contratar o ponto adicional wi-fi, o plano será migrado para o valor comercializado atualmente.</strong>
                </div>
                <div class="modal-footer">
    ...
    <!-- Modal PADRÃO NOC -->
    <div onmouseover="auto_preenchimento()" class="modal fade" id="padrao_noc" tabindex="3" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body" id="campo_padrao_verificao">
                    <input type="text" class="campo_preenchimento_ncc" placeholder="FHTT/ALCL" data-toggle="tooltip" data-placement="top" title="Em casos de ALCL verifique no TR069 previamente."> <br>
                    ...
                    <input type="text" class="campo_preenchimento_ncc2" placeholder="Motivo da verificação" data-toggle="tooltip" data-placement="top" title="Em casos de cabo rompido/baixo, informar se é o drop"> <br>
                    <input type="text" class="campo_preenchimento_ncc" placeholder="Nome"> <br>
                    <input type="text" class="campo_preenchimento_ncc" placeholder="n° de telefone do cliente"> <br>
                    <br>
                    <button type="button" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Exclusivo para os casos de cabo rompido/baixo (se não se enquandra, não precisa marcar)">Apresenta risco de acidente?</button>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="3" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="topoB">PADRÕES DE PREENCHIMENTO</h5>
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">🤖⏬</a>
                    <div class="dropdown-menu" id="menu_rapido_modelos">
                ...
                <div class="modal-body" id="botoes_auto_preenchidos">
                    <span class="preenchidos_conteiner modelos_pad_pessoais"> </span>
    ...
    <div class="modal fade" id="modal_modelos_padroes" tabindex="3" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="topoA">PADRÕES DE PREENCHIMENTO</h5>
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">🤖⏬</a>
                    <div class="dropdown-menu" id="menu_rapido_modelos_padroes">
                        <!-- <a class="dropdown-item" href="#one">one</a>
                        <a class="dropdown-item" href="#two">two</a>
                        <div role="separator" class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#three">three</a> -->
                ...
                <div class="modal-body modelos_pad" id="botoes_auto_preenchidos">
                    ...
                    <button class="btn btn-outline-dark" data-toggle="tooltip" data-placement="top" title=""
                        id="fun_ver_finan" onclick="fun_ver_finan()" onmouseover="tooltips_fun_ver_finan()">Verificação com
                        o FINANCEIRO</button><br>
        ...
        <div class="row">
            ...
            <div class="col">
                <div id="celula_atd_1" class="">
                    ...
                    <div id="dados_iniciais" class="bordaBranca">
                        ...
                        <input type="number" class="protocolos" id="protocolo_adm" placeholder="Prot. Gerado" style="color: red;" data-toggle="tooltip" data-placement="top" title="Protocolo que você está gerando para o atendimento."> 
                        <input type="number" class="protocolos" id="protocolo_ref_adm" placeholder="Prot. Ref. ADM"  style="color: red;" data-toggle="tooltip" data-placement="top" title="Protocolo que já existia no ADM (que originou o retorno)"> <br>
                        ...
                        <p id="tags_html" class="tags_show">
                            ...
                            <span type="button" id="" class="btn btn-outline-light btn_salvar_pend"
                                ...
                                title="Salve seus atendimentos para que o prox. operador resgate todas informações nas transferências (exclusivo chat)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <div id="vs" class="bordaBranca">
                        ...
                        <span id="hpfr" onchange="fun_h_preferencia()">
                            <select id="h_preferencia" onchange="fun_h_preferencia()" data-toggle="tooltip" title="Selecione o período.">
                                <option></option>
                        ...
                        <input type="date" id="data" data-toggle="tooltip" title="🗓️Data 1">
                        <input type="date" id="data2" data-toggle="tooltip" title="🗓️Data 2 (exclusivo para serviços)">
                        <input type="date" id="data3" data-toggle="tooltip" title="🗓️Data 3 (exclusivo para serviços)">
                        <br>
                        <span id="t2">
                        ...
                        <span class="mouse_ponteiro" id="t4" data-toggle="tooltip" title="Informar ao cliente que um maior de idade deve receber o técnico no dia da visita.">
                            <input class="mouse_ponteiro" type="checkbox" name="" id="maiorIdade" > 
                            <label class="mouse_ponteiro" for="maiorIdade">Cliente ciente de que deve haver uma pessoa maior de idade.</label>
                        </span> <br>
                        <span class="mouse_ponteiro" id="t5" data-toggle="tooltip" title="Se for identificado que a baixa do protocolo de instalação ocorreu há 30 dias corridos ou menos, na descrição desse protocolo deve conter o texto GARANTIA DE INSTALACAO.">
                            <input class="mouse_ponteiro" type="checkbox" name="" id="garantia"> 
                            <label class="mouse_ponteiro" for="garantia">Garantia de Instalação (30 dias).</label>                            
                        </span>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col"><button type="button" id="Copiar" class="btn btn_width btn-warning"
                                        onclick="copiar()" data-toggle="tooltip" title=""> Copiar <svg xmlns="http://www.w3.org/2000/svg" fill="black"
                                            height="1em"
            ...
            <div id="botoes_laterais" class="oculto" onmouseover="ativar_arrasto()" onmouseleave="desativar_arrasto()">
                ...
                <div id="mydiv">
                    ...
                    <div id="mydivheader" class="oculto"  onmouseout="pegarPosicao()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <script src="funcoes/Scrollspy.js"></script>
